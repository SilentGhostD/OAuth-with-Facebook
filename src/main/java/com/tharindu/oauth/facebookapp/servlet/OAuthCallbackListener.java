...
public class OAuthCallbackListener extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if (authorizationCode != null && authorizationCode.length() > 0) {
            ...
            final String REDIRECT_URI = "http://localhost:8080/facebookapp";
            final String CLIENT_ID = "159330037933855";
            final String CLIENT_SECRET = "12098ed8b69fbd3b81355997b099566c";
